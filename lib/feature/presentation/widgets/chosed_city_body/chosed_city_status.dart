...
class ChosedCityStatus extends StatelessWidget {
  const ChosedCityStatus({Key? key}) : super(key: key);
              ...
              children: [
                Column(
                  children: [
                    ...
                    Text(
                      '${state.currentWeatherByCity!.windspeed} m/s',
                      style: TextStyle(
                ...
                Column(
                  children: [
                    ...
                    SizedBox(height: context.height10 / 2),
                    Text(
                      '${state.currentWeatherByCity!.humidity} %',
                      style: TextStyle(
                        color: Colors.white70,
                        fontSize: context.height20,
                        fontWeight: FontWeight.w600,
