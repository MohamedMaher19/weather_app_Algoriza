...
class ChosedCitySunTime extends StatelessWidget {
  const ChosedCitySunTime({Key? key}) : super(key: key);
                    ...
                    Text(
                      DateFormat('h:mm a').format(
                          DateTime.fromMillisecondsSinceEpoch(
                              state.currentWeatherByCity!.sunrise * 1000)),
                      style: TextStyle(
                        color: Colors.white,
                        fontSize: context.height20,
                        fontWeight: FontWeight.w600,
                ...
                Column(
                  children: [
                    ...
                    Text(
                      DateFormat('h:mm a').format(
                          DateTime.fromMillisecondsSinceEpoch(
                              state.currentWeatherByCity!.sunset * 1000)),
                      style: TextStyle(
                        color: Colors.white,
                        fontSize: context.height20,
                        fontWeight: FontWeight.w600,
